...
(function(){
  ...
  M.concorrentes = {
    ...
    mount(c){
      ...
      c.querySelectorAll("[data-cc]").forEach(card=>card.addEventListener("click",()=>formCc(concorrentes().find(x=>x.id===card.dataset.cc))));
    }
  };
  function formCc(ed){
    ed=ed||{};
